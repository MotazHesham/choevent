      ...
      <div class="container-fluid display-table">
         ...
         <div class="addevent">
            <div class="row">
               <div class="col-lg-12">
                  <p style='color: #fff; '>
                     طلبات رعاية الفعالية  : {{$event->name}}
                  </p>
               </div>
               <div class="col-md-12">             
            ...
            <table role="table">
               <thead role="rowgroup">
                  <tr role="row">
                     ...
                     <th role="columnheader">الفئة</th>
                     <th role="columnheader">السعر</th>
                     <th role="columnheader">الحالة</th>
                     <th role="columnheader">الشركة الراعية</th>
               ...
               <tbody role="rowgroup" id="table-body">
                  ...
                  <tr>
                    ...
                    <td role="cell"> {{$order->classification}}</td>
                  ...
                  <td>
                     ...
                     <a class="btn btn-xs btn-primary"  href="{{route('website.offers.index',['order_id'=>$order->id,'type'=>'sponsoring'])}}"> 
                        العروض
                     </a>
         ...
         <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <label >الفئة:</label>  
                    <input type="text" name="classification" class="form-control" placeholder="فئة الطلب"  autofocus="" />
                 </div>
...
<script>
   function passOrderToModel(order){
      $('#order-details').empty();
      $('#order-details').append('<tr><th>اسم الطلب</th><td>'+order.name+'</td></tr><tr><th>فئة الطلب</th><td>'+order.classification+'</td></tr><tr><th>سعر الطلب</th><td>'+order.price+'</td></tr><tr><th>الوصف</th><td>'+order.description+'</td></tr>');
