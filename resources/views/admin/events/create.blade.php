                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('lat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="lat" id="lat" value="{{ old('lat', '') }}" step="0.0000000001">
                            @if($errors->has('lat'))
                        ...
                        <div class="form-group {{ $errors->has('lng') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="lng" id="lng" value="{{ old('lng', '') }}" step="0.0000000001">
                            @if($errors->has('lng'))
                        ...
                        <div class="form-group {{ $errors->has('start_at') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="start_at" id="start_at" value="{{ old('start_at') }}">
                        ...
                        <div class="form-group {{ $errors->has('end_at') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="end_at" id="end_at" value="{{ old('end_at') }}">
                        ...
                        <div class="form-group {{ $errors->has('age_max') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="age_max" id="age_max" value="{{ old('age_max', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('age_min') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="age_min" id="age_min" value="{{ old('age_min', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('nationality') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="nationality" id="nationality">
                                ...
                                @foreach(App\Models\Event::NATIONALITY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('nationality', 'any') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('sex') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="sex" id="sex">
                                ...
                                @foreach(App\Models\Event::SEX_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('sex', 'any') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('sex'))
                        ...
                        <div class="form-group {{ $errors->has('ticket_count') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="ticket_count" id="ticket_count" value="{{ old('ticket_count', '') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('ticket_start') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="ticket_start" id="ticket_start" value="{{ old('ticket_start') }}">
                        ...
                        <div class="form-group {{ $errors->has('ticket_end') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="ticket_end" id="ticket_end" value="{{ old('ticket_end') }}">
