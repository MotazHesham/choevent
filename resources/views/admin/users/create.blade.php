                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('company_register') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="company_register" id="company_register" value="{{ old('company_register', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('group') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="group" id="group">
                                ...
                                @foreach(App\Models\User::GROUP_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('group', 'user') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('group'))
