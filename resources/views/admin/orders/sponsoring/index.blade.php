...
<div class="content">
    @can('order_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.orders.create',['type'=>'sponsoring']) }}">
                    
                    {{ trans('global.add') }} {{ trans('cruds.sponsoring_order.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.sponsoring_order.title_singular') }} 
                </div>
                            ...
                            <tbody>
                                @foreach($orders as $key => $order)
                                    <tr data-entry-id="{{ $order->id }}">
                                        ...
                                        <td>
                                            <span style="display:none">{{ $order->publish ?? '' }}</span>
