                    ...
                    <form method="POST" action="{{ route("admin.articles.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('main_slider') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="main_slider" id="main_slider" value="1" {{ old('main_slider', 0) == 1 ? 'checked' : '' }}>
                                <label for="main_slider" style="font-weight: 400">{{ trans('cruds.article.fields.main_slider') }}</label>
                            </div>
                            @if($errors->has('main_slider'))
                                <span class="help-block" role="alert">{{ $errors->first('main_slider') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.article.fields.main_slider_helper') }}</span>
                        </div>
