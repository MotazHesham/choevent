                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.articles.update", [$article->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $article->description) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('main_slider') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="main_slider" id="main_slider" value="1" {{ $article->main_slider || old('main_slider', 0) === 1 ? 'checked' : '' }}>
